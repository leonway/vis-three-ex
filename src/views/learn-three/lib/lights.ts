...
export const directionalLight:DirectionalLight = new DirectionalLight('rgb(255,255,255)',1)
...
export const pointLight:PointLight = new PointLight('rgb(255,255,255)',0.7,50,0.1)
pointLight.position.set(60,20,-20)
